...
export default function About({ theStyle }: { theStyle?: InterfaceProps }) {
  return (
    <section className={`py-16 px-12 ${theStyle?.normal}`}>
      <div className="container mx-auto px-4">
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className={`text-2xl font-bold mb-4 ${theStyle?.title}`}>Notre Mission</h3>
            <p className="mb-6">
            ...
            <h3 className={`text-2xl font-bold mb-4 ${theStyle?.title}`}>Notre Vision</h3>
            <p className="mb-6">
            ...
            <h3 className={`text-2xl font-bold mb-4 ${theStyle?.title}`}>Nos Valeurs</h3>
